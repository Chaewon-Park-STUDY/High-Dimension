...
- When λ=0 , no penalty is applied
- When λ-> ∞, the penalty dominates, forcing all βⱼ = 0
The model becomes a constant predictor: ŷᵢ = α = ȳ where, α is the intercept and it is not penalized. 
minimize over α:    ∑ᵢ (yᵢ - α)²
Take derivative:     d/dα ∑ᵢ (yᵢ - α)² = 0   ⇒   α = ȳ
...
<br>
- If the boxplot is skewed--> Estimated beta hat do not change much even when the data changes(Estimated β1)
- Estimated β3, β4, β6, and β7 remains zero regardless of the data--> Not important variables
...
### ✅ (Variable) Feature Selection Property
- Under some appropriate  λ value, some coefficients forced to be zero
...
<br>
Ex)
<img src="https://raw.githubusercontent.com/Chaewon-Park-STUDY/High-Dimension/main/images/20.png" width="400"/>
➡️Even when underlying beta is not sparse, Lasso provides meaningful  solution in the sense that first, fourth, fifth variables are important when we explain the response variable compared to other variables
...
➡️ Advantages
<br>
<img src="https://raw.githubusercontent.com/Chaewon-Park-STUDY/High-Dimension/main/images/21.png" width="500"/>
<br>
➡️ Disadvantages
<img src="https://raw.githubusercontent.com/Chaewon-Park-STUDY/High-Dimension/main/images/22.png" width="500"/>
---
