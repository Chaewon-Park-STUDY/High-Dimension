...
-> Even when underlying beta is not sparse, Lasso provides meaningful  solution in the sense that first, fourth, fifth variables are important when we explain the response variable compared to other variables
